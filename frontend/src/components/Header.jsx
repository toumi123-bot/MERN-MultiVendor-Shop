...
const Header = () => {
   ...
   <div onClick={()=> setShowSidebar(true)} className={`fixed duration-200 transition-all ${showShidebar ? 'invisible' : 'visible'} hidden md-lg:block w-screen h-screen bg-[rgba(0,0,0,0.5)] top-0 left-0 z-20 `}>          </div> 
    ...
    <ul className='flex flex-col justify-start items-start text-sm font-bold uppercase'>
        ...
        <div className='flex justify-end flex-col gap-1'>
            <h2 className='text-sm font-medium text-slate-700'>+216 70 295 460</h2>
...
<ul className='py-2 text-slate-600 font-medium'>
        ...
        <div className='flex justify-end flex-col gap-1'>
            <h2 className='text-md font-medium text-slate-700'>+216 70 295 460</h2>
