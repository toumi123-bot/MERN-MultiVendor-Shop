            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-2xl text-red-500 font-bold flex gap-3 ">
                {product.discount !== 0 ? (
                  <>
                    Price :{" "}
                    <h2 className="line-through">{product.price} TND</h2>
                    <h2>
                      {product.price -
                        Math.floor(
                          (product.price * product.discount) / 100
                        )}{" "}
                      TND (-{product.discount}%){" "}
                    </h2>
                  </>
                ) : (
              ...
              <div className="flex py-5 gap-5">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <ul className="flex justify-start items-center gap-3">
                    ...
                    <li>
                      <a
                        className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-[#0077B5] rounded-full text-white"
