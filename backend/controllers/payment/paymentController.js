...
const stripe = require("stripe")(
  "sk_test_51Q5pOLF4md42MzNFfd346XC4Ei7UQAadIsfGlApQRmoY7LTNTKCrkzzrXV7LHegwEVhXjoGd4LnCkQI6dDvDiFAB00dT4MULfg"
);
    ...
    try {
      ...
      if (stripeInfo) {
        ...
        const accountLink = await stripe.accountLinks.create({
          account: account.id,
          refresh_url:
            "https://ambitious-desert-0d4d5481e.1.azurestaticapps.net/refresh",
          return_url: `https://ambitious-desert-0d4d5481e.1.azurestaticapps.net/success?activeCode=${uid}`,
